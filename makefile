#if 0
CXX=icpc
CXXFLAGS=-O3 -g -lrt -lpthread -march=native -std=c++11 -Wall -Wextra -Wshadow -Wno-unused-result -fopenmp -DON_NUMA -pg -DUSE_EDGE_STRUCT -DON_HOME -DUSE_REORDER_BFS -DUSE_SKIP_LOOPSq=1 -DUSE_RESULT_VERTEX -DUSE_ANSWER_IN_VECTOR -DPREFETCH_START_EDGE=20 -DMAGIC_BOUND=100
