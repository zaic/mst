#if 0
CXX=icpc
CXXFLAGS=-O0 -g -lrt -lpthread -march=native -std=c++11 -Wall -Wextra -Wshadow -Wno-unused-result -fopenmp -DON_NUMA -pg -DUSE_EDGE_STRUCT -DON_HOME -DUSE_REORDER_BFS -DUSE_SKIP_LOOPSq=1 -DUSE_RESULT_VERTEX -DUSE_ANSWER_IN_VECTOR -DPREFETCH_START_EDGE=20 -DMAGIC_BOUND=100 -DPREFETCH_PJ_COMP=20
...
boruvka_el.out: gen.o boruvka_el.cpp makefile.h
	${CXX} ${CXXFLAGS} -DUSE_FAST_REDUCTION -DUSE_REDUCTION_MESSAGES -DUSE_SKIP_LAST_ITER -DUSE_COMPRESS $^ -o $@
